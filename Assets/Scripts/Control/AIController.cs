...
namespace Car.Control
{
    public class AIController : MonoBehaviour
    {
        ...
        {
            // NavMeshPath path = mover.GetCurrentNavPath();
            ...
            // corners = currentPath.corners;
            // if (corners.Length == 0) return;
            // goal = corners[currentCornerWP];
            // if (Vector3.Distance(goal, transform.position) < waypointAccuracy)
            // {
            //     currentCornerWP++;
            //     if (currentCornerWP >= corners.Length) // todo should go back to beginning of path?
            //     {
            //         currentCornerWP = 0;
            //     }
            // }
